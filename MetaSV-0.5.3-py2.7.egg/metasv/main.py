...
def run_metasv(args):
    ...
    if not (args.pindel_vcf + args.breakdancer_vcf + args.breakseq_vcf + args.cnvnator_vcf +
            ...
            args.manta_vcf + args.delly_vcf, args.lumpy_vcf + args.cnvkit_vcf, args.contra_vcf, args.wham_vcf):
    ...
    vcf_name_list = [("CNVnator", args.cnvnator_vcf), ("Pindel", args.pindel_vcf),
                     ...
                     ("Lumpy", args.lumpy_vcf), ("Manta", args.manta_vcf), ("Delly", args.delly_vcf), ("CNVkit", args.cnvkit_vcf), ("Contra", args.contra_vcf),
                     ("WHAM", args.wham_vcf)]
